...
|US46|Remove Partner|Low|As a *Moderator*, I want to be able to remove a partner, so that the partner no longer reaches a bigger audience with his posts
|US47|Add FAQ| Low |As a *Moderator*, I want to be able to add a new Question and the respective Answer to the FAQ, so thet other Users can see it in the FAQ
...
BR02 | Guest User's Reputation | Every Guest user has a reputation equal to 0 
BR03 | Partner | A User is only able to request the label of Partner when it reaches a reputation of 1000
