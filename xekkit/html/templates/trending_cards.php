   ...
   <div id="trending">
     ...
     <div class="wrapper">
      ...
      <div class="trending_card">
        ...
        <a class="clickable card_text card_author" href="#">
          <i class="fas fa-user-circle"></i> 
          u/deepfuckingvalue
       </a>
        <span class="card_text card_title">1</span>
        <div class="card_tags">
          <a class="clickable card_text" href="#">economics</a>
          <a class="clickable card_text" href="#">finance</a>
        </div>
        
        <span class="card_text card_date">Jan 21, 2021</span>
