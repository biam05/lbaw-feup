...
<div class="modal fade text-white" id="reportContent_{{$report_to_id}}" tabindex="-1" aria-labelledby="Report-modal-label" aria-hidden="true">
@endif
@if ($type=="user")
<div class="modal fade text-white" id="reportUser_{{$report_to_id}}" tabindex="-1" aria-labelledby="Report-modal-label" aria-hidden="true">
@endif  
